...
var URL_CUSTOMER = 'app/customerlist.json';
var CustomerService = (function () {
    ...
    CustomerService.prototype.getCustomerList_Observable = function () {
        return this._http.get(URL_CUSTOMER)
            .map(function (response) { return response.json(); })
    ...
    CustomerService.prototype._handleError = function (err) {
        ...
        return Rx_1.Observable.throw(err); // opportunity to customise error
    };
